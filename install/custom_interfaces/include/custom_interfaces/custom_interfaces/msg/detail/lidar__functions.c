...
custom_interfaces__msg__Lidar__create(void)
{
  ...
  custom_interfaces__msg__Lidar * msg = (custom_interfaces__msg__Lidar *)allocator.allocate(sizeof(custom_interfaces__msg__Lidar), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_interfaces__msg__Lidar));
  bool success = custom_interfaces__msg__Lidar__init(msg);
  if (!success) {
...
custom_interfaces__msg__Lidar__Sequence__init(custom_interfaces__msg__Lidar__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__msg__Lidar * data = NULL;

  if (size) {
    data = (custom_interfaces__msg__Lidar *)allocator.zero_allocate(size, sizeof(custom_interfaces__msg__Lidar), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_interfaces__msg__Lidar__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_interfaces__msg__Lidar__fini(&data[i - 1]);
      }
...
custom_interfaces__msg__Lidar__Sequence__fini(custom_interfaces__msg__Lidar__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_interfaces__msg__Lidar__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__msg__Lidar__Sequence * array = (custom_interfaces__msg__Lidar__Sequence *)allocator.allocate(sizeof(custom_interfaces__msg__Lidar__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_interfaces__msg__Lidar__Sequence__init(array, size);
  if (!success) {
...
custom_interfaces__msg__Lidar__Sequence__destroy(custom_interfaces__msg__Lidar__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_interfaces__msg__Lidar__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_interfaces__msg__Lidar__Sequence__are_equal(const custom_interfaces__msg__Lidar__Sequence * lhs, const custom_interfaces__msg__Lidar__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_interfaces__msg__Lidar__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_interfaces__msg__Lidar__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_interfaces__msg__Lidar);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_interfaces__msg__Lidar * data =
      (custom_interfaces__msg__Lidar *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interfaces__msg__Lidar__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_interfaces__msg__Lidar__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_interfaces__msg__Lidar__copy(
