...
{
  new (message_memory) custom_interfaces::msg::Battery(_init);
}

void Battery_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::Battery *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Battery_message_member_array[2] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::Battery, percentage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Battery_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces::msg::Battery),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Battery_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Battery)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Battery_message_type_support_handle;
}
