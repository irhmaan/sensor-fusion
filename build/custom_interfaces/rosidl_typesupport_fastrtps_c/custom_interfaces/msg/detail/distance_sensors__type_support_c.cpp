...
#include "custom_interfaces/msg/detail/distance_sensors__rosidl_typesupport_fastrtps_c.h"
...
using _DistanceSensors__ros_msg_type = custom_interfaces__msg__DistanceSensors;
...
{
  // Field name: ultrasonic_front
  {
    cdr << ros_message->ultrasonic_front;
  }

  // Field name: ultrasonic_left
  {
    cdr << ros_message->ultrasonic_left;
  }

  // Field name: ultrasonic_right
  {
...
{
  const _DistanceSensors__ros_msg_type * ros_message = static_cast<const _DistanceSensors__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__DistanceSensors;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_interfaces__msg__DistanceSensors * ros_message = static_cast<const custom_interfaces__msg__DistanceSensors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_interfaces__msg__DistanceSensors(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_interfaces__msg__DistanceSensors * ros_message = static_cast<custom_interfaces__msg__DistanceSensors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_interfaces__msg__DistanceSensors(cdr, ros_message);
}

static uint32_t _DistanceSensors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__DistanceSensors(
...
static size_t _DistanceSensors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__DistanceSensors(
...
static message_type_support_callbacks_t __callbacks_DistanceSensors = {
...
static rosidl_message_type_support_t _DistanceSensors__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DistanceSensors,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, DistanceSensors)() {
  return &_DistanceSensors__type_support;
}
