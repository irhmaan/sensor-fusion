...
bool custom_interfaces__msg__motors__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._motors.Motors", full_classname_dest, 36) == 0);
  }
  custom_interfaces__msg__Motors * ros_message = _ros_message;
  {  // left_pwm
...
PyObject * custom_interfaces__msg__motors__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._motors");
