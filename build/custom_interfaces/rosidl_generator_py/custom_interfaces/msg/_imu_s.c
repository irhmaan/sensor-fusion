...
bool custom_interfaces__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * custom_interfaces__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._imu");
