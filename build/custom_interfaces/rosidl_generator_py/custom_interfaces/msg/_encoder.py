...
class Encoder(metaclass=Metaclass_Encoder):
    ...
    def left_ticks(self, value):
        if self._check_fields:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'left_ticks' field must be an integer in [-9223372036854775808, 9223372036854775807]"
    ...
    def right_ticks(self, value):
        if self._check_fields:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'right_ticks' field must be an integer in [-9223372036854775808, 9223372036854775807]"
