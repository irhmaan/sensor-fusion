...
#include "custom_interfaces/msg/detail/encoder__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Encoder & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Encoder & ros_message)
{
  // Member: left_ticks
  cdr >> ros_message.left_ticks;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Encoder;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Encoder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Encoder *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Encoder__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Encoder)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Encoder__handle;
}
