...
#include "custom_interfaces/msg/detail/battery__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Battery;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Battery *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Battery *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Battery__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Battery)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Battery__handle;
}
