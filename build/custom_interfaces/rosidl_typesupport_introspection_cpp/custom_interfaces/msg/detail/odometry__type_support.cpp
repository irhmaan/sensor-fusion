...
{
  new (message_memory) custom_interfaces::msg::Odometry(_init);
}

void Odometry_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::Odometry *>(message_memory);
  typed_message->~Odometry();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Odometry_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(custom_interfaces::msg::Odometry, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::Odometry, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::Odometry, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Odometry_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_interfaces::msg::Odometry),
...
get_message_type_support_handle<custom_interfaces::msg::Odometry>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Odometry)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
