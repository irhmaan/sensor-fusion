...
bool custom_interfaces__msg__battery__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // percentage
    ...
    ros_message->percentage = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * custom_interfaces__msg__battery__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._battery");
  ...
  {  // percentage
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->percentage);
    {
