...
bool custom_interfaces__msg__lidar__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._lidar.Lidar", full_classname_dest, 34) == 0);
  }
  custom_interfaces__msg__Lidar * ros_message = _ros_message;
  {  // distances
  ...
  {  // angles
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int64_t * dest = ros_message->angles.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
PyObject * custom_interfaces__msg__lidar__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._lidar");
  ...
  {  // angles
    ...
    if (ros_message->angles.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t * src = &(ros_message->angles.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->angles.size * sizeof(int64_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
