...
bool custom_interfaces__msg__environment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._environment.Environment", full_classname_dest, 46) == 0);
  }
  custom_interfaces__msg__Environment * ros_message = _ros_message;
  {  // temperature
...
PyObject * custom_interfaces__msg__environment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._environment");
